    ...
    <>
      <div>
        ...
        <div className="header_img_div">
          <img src="images/Contact/contactbg.png" className="header-header-bg_styles" />
          ...
          <form action="" onSubmit={handleSubmit}>
            ...
            <div className="contactsection">
              ...
              <div className="contactus-email">
                ...
                <a style={{ textDecoration: "none" }} href="mailto:contact@gurushree.in"><p > contact@gurushree.in <br />  </p></a>
              </div>
            ...
            <div className="contactus-address">
              ...
              <div className="contact-address-address">
                <p>
                  ...
                  <span className='enquiry_mail_contact'>
