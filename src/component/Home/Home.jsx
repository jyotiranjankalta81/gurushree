        ...
        <div className="our_card" data-aos="zoom-in-down">
          <div className="our_card1">
            ...
            <Link to='/industries' className="our_para1">
              <img src='images/Home/pause.png' className="our_img" />
          ...
          <div className="our_card3">
            ...
            <a href="https://www.tatasteel.com/" className="our_para3">
              <img src='images/Home/pause.png' className="our_img" alt="" />
              <p><img src='images/Home/tata.png' alt="" /></p>
            </a>

            <a href="https://www.sail.co.in/en/home" className="our_para3">
              <img src='images/Home/pause.png' className="our_img" alt="" />
            ...
            <a href="https://www.jswsteel.in/" className="our_para3">
              <img src='images/Home/pause.png' className="our_img" alt="" />
              <p><img src='images/Home/jsw.jpeg' alt="" className='clients_img1' /></p>
            </a>

            <a href="https://www.aionjsw.in/" className="our_para3">
              <img src='images/Home/pause.png' className="our_img" alt="" />
            ...
            <a href="https://www.vizagsteel.com/" className="our_para3">
              <img src='images/Home/pause.png' className="our_img" alt="" />
          ...
          <div className="qoutes-section" data-aos="flip-up">
            <div ref={myRef} className="main_div-qoutes-scroll ">
              <div className="first-qoutes">
                {/* <img src="images/circularuser.svg" alt="" className="client_img" style={{ "color": 'white' }} /> */}
            ...
            <div ref={myRef} className="main_div-qoutes-scroll main_div-qoutes-scroll1">
              <div className="first-content">
                {/* <img src="images/circularuser.svg" alt="" /> */}
                <img src="images/doublecomma.jpg" alt="" />
